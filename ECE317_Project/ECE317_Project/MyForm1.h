...
#pragma region Windows Form Designer generated code
		...
		{
			this->labelt2 = (gcnew System::Windows::Forms::Label());
			this->Orderlabel2 = (gcnew System::Windows::Forms::Label());
			this->btn_send2 = (gcnew System::Windows::Forms::Button());
			...
			this->labelt2->Location = System::Drawing::Point(12, 9);
			this->labelt2->Name = L"labelt2";
			this->labelt2->Size = System::Drawing::Size(40, 13);
			this->labelt2->TabIndex = 0;
			this->labelt2->Text = L"Table2";
			// 
			// Orderlabel2
			// 
			this->Orderlabel2->AutoSize = true;
			this->Orderlabel2->Location = System::Drawing::Point(179, 9);
			this->Orderlabel2->Name = L"Orderlabel2";
			this->Orderlabel2->Size = System::Drawing::Size(33, 13);
			this->Orderlabel2->TabIndex = 3;
			this->Orderlabel2->Text = L"Order";
			// 
			// btn_send2
			// 
			this->btn_send2->Location = System::Drawing::Point(326, 347);
			this->btn_send2->Name = L"btn_send2";
			this->btn_send2->Size = System::Drawing::Size(75, 23);
			this->btn_send2->TabIndex = 4;
			this->btn_send2->Text = L"Send";
			this->btn_send2->UseVisualStyleBackColor = true;
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(104, 220);
			...
			this->checkedListBox3->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Beer\t\t\t€3.00", L"Soft Drinks\t\t€1.00", 
				L"Water\t\t\t€1.00"});
			this->checkedListBox3->Location = System::Drawing::Point(66, 237);
			...
			this->label7->Location = System::Drawing::Point(104, 138);
			...
			this->checkedListBox2->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Souvlaki-Chicken            €5.00", L"Souvlaki-Beef\t\t€6.00", 
				L"Steak\t\t\t€4.00"});
			this->checkedListBox2->Location = System::Drawing::Point(66, 155);
			...
			this->label4->Location = System::Drawing::Point(104, 47);
			...
			this->label2->Location = System::Drawing::Point(308, 34);
			...
			// numericUpDown11
			// 
			this->numericUpDown11->Location = System::Drawing::Point(15, 56);
			...
			// numericUpDown10
			// 
			this->numericUpDown10->Location = System::Drawing::Point(15, 82);
			...
			// numericUpDown8
			// 
			this->numericUpDown8->Location = System::Drawing::Point(15, 281);
			...
			// numericUpDown7
			// 
			this->numericUpDown7->Location = System::Drawing::Point(15, 255);
			...
			// numericUpDown5
			// 
			this->numericUpDown5->Location = System::Drawing::Point(15, 229);
			...
			// numericUpDown4
			// 
			this->numericUpDown4->Location = System::Drawing::Point(15, 194);
			...
			// numericUpDown3
			// 
			this->numericUpDown3->Location = System::Drawing::Point(15, 168);
			...
			// numericUpDown2
			// 
			this->numericUpDown2->Location = System::Drawing::Point(13, 142);
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(15, 108);
			...
			this->checkedListBox1->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Cypriot-Salad\t\t€3.50", L"Caesar\t\t\t€4.00", 
				L"Hellenic\t\t\t€3.00"});
			this->checkedListBox1->Location = System::Drawing::Point(66, 64);
			...
			// textBox10
			// 
			this->textBox10->Location = System::Drawing::Point(276, 64);
			...
			this->ClientSize = System::Drawing::Size(474, 441);
