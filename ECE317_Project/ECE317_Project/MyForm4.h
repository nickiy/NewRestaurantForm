...
namespace ECE317_Project {
	...
	private: System::Windows::Forms::Label^  Orderlabel5;
...
#pragma region Windows Form Designer generated code
		...
		{
			this->labelt5 = (gcnew System::Windows::Forms::Label());
			this->Orderlabel5 = (gcnew System::Windows::Forms::Label());
			this->btn_send5 = (gcnew System::Windows::Forms::Button());
			...
			this->labelt5->Location = System::Drawing::Point(3, 0);
			this->labelt5->Name = L"labelt5";
			this->labelt5->Size = System::Drawing::Size(40, 13);
			this->labelt5->TabIndex = 0;
			this->labelt5->Text = L"Table5";
			// 
			// Orderlabel5
			// 
			this->Orderlabel5->AutoSize = true;
			this->Orderlabel5->Location = System::Drawing::Point(147, 0);
			this->Orderlabel5->Name = L"Orderlabel5";
			this->Orderlabel5->Size = System::Drawing::Size(33, 13);
			this->Orderlabel5->TabIndex = 1;
			this->Orderlabel5->Text = L"Order";
			this->Orderlabel5->Click += gcnew System::EventHandler(this, &MyForm4::Orderlabel5_Click);
			// 
			// btn_send5
			// 
			this->btn_send5->Location = System::Drawing::Point(302, 311);
			this->btn_send5->Name = L"btn_send5";
			this->btn_send5->Size = System::Drawing::Size(75, 23);
			this->btn_send5->TabIndex = 6;
			this->btn_send5->Text = L"Send";
			...
			this->checkedListBox3->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Beer\t\t\t€3.00", L"Soft Drinks\t\t€1.00", 
				L"Water\t\t\t€1.00"});
			this->checkedListBox3->Location = System::Drawing::Point(58, 225);
			...
			this->label7->Location = System::Drawing::Point(96, 126);
			...
			this->checkedListBox2->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Souvlaki-Chicken            €5.00", L"Souvlaki-Beef\t\t€6.00", 
				L"Steak\t\t\t€4.00"});
			this->checkedListBox2->Location = System::Drawing::Point(58, 143);
			...
			this->label4->Location = System::Drawing::Point(96, 35);
			...
			this->label2->Location = System::Drawing::Point(300, 22);
			...
			// numericUpDown11
			// 
			this->numericUpDown11->Location = System::Drawing::Point(7, 44);
			...
			// numericUpDown10
			// 
			this->numericUpDown10->Location = System::Drawing::Point(7, 70);
			...
			// numericUpDown8
			// 
			this->numericUpDown8->Location = System::Drawing::Point(7, 269);
			...
			// numericUpDown7
			// 
			this->numericUpDown7->Location = System::Drawing::Point(7, 243);
			...
			// numericUpDown5
			// 
			this->numericUpDown5->Location = System::Drawing::Point(7, 217);
			...
			// numericUpDown4
			// 
			this->numericUpDown4->Location = System::Drawing::Point(7, 182);
			...
			// numericUpDown3
			// 
			this->numericUpDown3->Location = System::Drawing::Point(7, 156);
			...
			// numericUpDown2
			// 
			this->numericUpDown2->Location = System::Drawing::Point(5, 130);
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(7, 96);
			...
			this->checkedListBox1->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Cypriot-Salad\t\t€3.50", L"Caesar\t\t\t€4.00", 
				L"Hellenic\t\t\t€3.00"});
			this->checkedListBox1->Location = System::Drawing::Point(58, 52);
			...
			// textBox10
			// 
			this->textBox10->Location = System::Drawing::Point(268, 52);
			...
			this->ClientSize = System::Drawing::Size(412, 408);
			...
			this->Controls->Add(this->Orderlabel5);
...
#pragma endregion
	private: System::Void Orderlabel5_Click(System::Object^  sender, System::EventArgs^  e) {
			 }
	};
}
