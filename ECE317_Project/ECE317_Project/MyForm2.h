...
namespace ECE317_Project {
	...
	private: System::Windows::Forms::Label^  Orderlabel3;
...
#pragma region Windows Form Designer generated code
		...
		{
			this->labelt3 = (gcnew System::Windows::Forms::Label());
			this->Orderlabel3 = (gcnew System::Windows::Forms::Label());
			this->btn_send3 = (gcnew System::Windows::Forms::Button());
			...
			this->labelt3->Location = System::Drawing::Point(12, 9);
			this->labelt3->Name = L"labelt3";
			this->labelt3->Size = System::Drawing::Size(40, 13);
			this->labelt3->TabIndex = 0;
			this->labelt3->Text = L"Table3";
			// 
			// Orderlabel3
			// 
			this->Orderlabel3->AutoSize = true;
			this->Orderlabel3->Location = System::Drawing::Point(167, 9);
			this->Orderlabel3->Name = L"Orderlabel3";
			this->Orderlabel3->Size = System::Drawing::Size(33, 13);
			this->Orderlabel3->TabIndex = 1;
			this->Orderlabel3->Text = L"Order";
			// 
			// btn_send3
			// 
			this->btn_send3->Location = System::Drawing::Point(333, 333);
			this->btn_send3->Name = L"btn_send3";
			this->btn_send3->Size = System::Drawing::Size(75, 23);
			this->btn_send3->TabIndex = 5;
			this->btn_send3->Text = L"Send";
			this->btn_send3->UseVisualStyleBackColor = true;
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(108, 220);
			...
			this->checkedListBox3->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Beer\t\t\t€3.00", L"Soft Drinks\t\t€1.00", 
				L"Water\t\t\t€1.00"});
			this->checkedListBox3->Location = System::Drawing::Point(70, 237);
			...
			this->label7->Location = System::Drawing::Point(108, 138);
			...
			this->checkedListBox2->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Souvlaki-Chicken            €5.00", L"Souvlaki-Beef\t\t€6.00", 
				L"Steak\t\t\t€4.00"});
			this->checkedListBox2->Location = System::Drawing::Point(70, 155);
			...
			this->label4->Location = System::Drawing::Point(108, 47);
			...
			this->label3->Location = System::Drawing::Point(108, 34);
			...
			this->label2->Location = System::Drawing::Point(312, 34);
			...
			// numericUpDown11
			// 
			this->numericUpDown11->Location = System::Drawing::Point(19, 56);
			...
			// numericUpDown10
			// 
			this->numericUpDown10->Location = System::Drawing::Point(19, 82);
			...
			// numericUpDown8
			// 
			this->numericUpDown8->Location = System::Drawing::Point(19, 281);
			...
			// numericUpDown7
			// 
			this->numericUpDown7->Location = System::Drawing::Point(19, 255);
			...
			// numericUpDown5
			// 
			this->numericUpDown5->Location = System::Drawing::Point(19, 229);
			...
			// numericUpDown4
			// 
			this->numericUpDown4->Location = System::Drawing::Point(19, 194);
			...
			// numericUpDown3
			// 
			this->numericUpDown3->Location = System::Drawing::Point(19, 168);
			...
			// numericUpDown2
			// 
			this->numericUpDown2->Location = System::Drawing::Point(17, 142);
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(19, 108);
			...
			this->checkedListBox1->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Cypriot-Salad\t\t€3.50", L"Caesar\t\t\t€4.00", 
				L"Hellenic\t\t\t€3.00"});
			this->checkedListBox1->Location = System::Drawing::Point(70, 64);
			...
			// textBox10
			// 
			this->textBox10->Location = System::Drawing::Point(280, 64);
			...
			this->ClientSize = System::Drawing::Size(458, 434);
			...
			this->Controls->Add(this->Orderlabel3);
