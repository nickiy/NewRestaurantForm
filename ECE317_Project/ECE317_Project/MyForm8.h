...
namespace ECE317_Project {
	...
	private: System::Windows::Forms::Label^  Orderlabel9;
...
#pragma region Windows Form Designer generated code
		...
		{
			this->labelt9 = (gcnew System::Windows::Forms::Label());
			this->btn_send9 = (gcnew System::Windows::Forms::Button());
			this->Orderlabel9 = (gcnew System::Windows::Forms::Label());
			...
			this->labelt9->Location = System::Drawing::Point(12, 9);
			this->labelt9->Name = L"labelt9";
			this->labelt9->Size = System::Drawing::Size(40, 13);
			this->labelt9->TabIndex = 0;
			this->labelt9->Text = L"Table9";
			// 
			// btn_send9
			// 
			this->btn_send9->Location = System::Drawing::Point(317, 339);
			this->btn_send9->Name = L"btn_send9";
			this->btn_send9->Size = System::Drawing::Size(75, 23);
			this->btn_send9->TabIndex = 6;
			this->btn_send9->Text = L"Send";
			this->btn_send9->UseVisualStyleBackColor = true;
			// 
			// Orderlabel9
			// 
			this->Orderlabel9->AutoSize = true;
			this->Orderlabel9->Location = System::Drawing::Point(151, 9);
			this->Orderlabel9->Name = L"Orderlabel9";
			this->Orderlabel9->Size = System::Drawing::Size(33, 13);
			this->Orderlabel9->TabIndex = 1;
			this->Orderlabel9->Text = L"Order";
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(105, 218);
			...
			this->checkedListBox3->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Beer\t\t\t€3.00", L"Soft Drinks\t\t€1.00", 
				L"Water\t\t\t€1.00"});
			this->checkedListBox3->Location = System::Drawing::Point(67, 235);
			...
			this->label7->Location = System::Drawing::Point(105, 136);
			...
			this->checkedListBox2->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Souvlaki-Chicken            €5.00", L"Souvlaki-Beef\t\t€6.00", 
				L"Steak\t\t\t€4.00"});
			this->checkedListBox2->Location = System::Drawing::Point(67, 153);
			...
			this->label4->Location = System::Drawing::Point(105, 45);
			...
			this->label3->Location = System::Drawing::Point(105, 32);
			...
			this->label2->Location = System::Drawing::Point(309, 32);
			...
			// numericUpDown11
			// 
			this->numericUpDown11->Location = System::Drawing::Point(16, 54);
			...
			// numericUpDown10
			// 
			this->numericUpDown10->Location = System::Drawing::Point(16, 80);
			...
			// numericUpDown8
			// 
			this->numericUpDown8->Location = System::Drawing::Point(16, 279);
			...
			// numericUpDown7
			// 
			this->numericUpDown7->Location = System::Drawing::Point(16, 253);
			...
			// numericUpDown5
			// 
			this->numericUpDown5->Location = System::Drawing::Point(16, 227);
			...
			// numericUpDown4
			// 
			this->numericUpDown4->Location = System::Drawing::Point(16, 192);
			...
			// numericUpDown3
			// 
			this->numericUpDown3->Location = System::Drawing::Point(16, 166);
			...
			// numericUpDown2
			// 
			this->numericUpDown2->Location = System::Drawing::Point(14, 140);
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(16, 106);
			...
			this->checkedListBox1->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Cypriot-Salad\t\t€3.50", L"Caesar\t\t\t€4.00", 
				L"Hellenic\t\t\t€3.00"});
			this->checkedListBox1->Location = System::Drawing::Point(67, 62);
			...
			// textBox10
			// 
			this->textBox10->Location = System::Drawing::Point(277, 62);
			...
			this->Controls->Add(this->btn_send9);
			this->Controls->Add(this->Orderlabel9);
